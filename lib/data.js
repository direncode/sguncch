...
// Budget categories for line items
...
// SG Priority areas for AI scoring
export const sgPriorities = [
  'Student Wellness',
  'Basic Needs',
  'Academic Support',
  'Diversity & Inclusion',
...
// Initial budget data - zeroed with expanded structure
export const initialBudgetData = {
  ...
  lineItems: [
    // Example structure:
    // {
    //   id: 1, orgName: 'Example Org', category: 'Events',
    //   requested: 1000, approved: 800, spent: 500,
    //   receiptsLink: '', status: 'approved', impactNotes: '',
    //   semester: 'Spring 2026', createdAt: '2026-01-01', updatedAt: '2026-01-15'
    // }
  ],

  // Funding Requests Queue (AI-Assisted)
  fundingRequests: [
    // Example structure:
    // {
    //   id: 1, orgName: 'Example Org', amount: 500, category: 'Events',
    //   description: 'Spring mixer event', impactJustification: 'Reaches 200+ students',
    //   priority: 'Student Wellness', urgency: 'normal', // or 'high' for crisis/wellness
    //   aiScore: 85, aiRecommendation: 'Approve — high impact',
    //   status: 'pending', // pending, approved, denied, reallocated
    //   submittedAt: '2026-01-20', reviewedAt: null, reviewerNote: ''
    // }
  ],

  // Rate limiting tracker: { orgName: { weekStart: count } }
  requestRateLimits: {},
  ...
  reallocationSuggestions: [
    // Example structure:
    // {
    //   id: 1, fromCategory: 'Merch', fromOrg: 'Org A',
    //   toCategory: 'Wellness', toOrg: 'Org B',
    //   amount: 500, reason: 'Low spend in Merch, high demand in Wellness',
    //   status: 'pending', // pending, approved, rejected
    //   createdAt: '2026-01-20', reviewedAt: null
    // }
  ],

  // Approved reallocations for public display
  approvedReallocations: [],

  // Waste reduction metrics
  wasteMetrics: {
    totalReallocated: 0,
    unusedFundsRecovered: 0,
    requestsProcessedWithinDay: 0,
