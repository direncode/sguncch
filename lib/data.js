...
export const ADMIN_KEY = process.env.ADMIN_KEY || process.env.NEXT_PUBLIC_ADMIN_KEY || DEFAULT_DEV_KEY
...
// Budget Enhancement - Sample Line Items (for demo mode)
export const sampleBudgetLineItems = [
  {
    id: 1,
    orgName: 'Carolina Cupboard',
    category: 'food',
    description: 'Spring semester food pantry supplies',
    requested: 5000,
    approved: 4500,
    spent: 2800,
    status: 'approved',
    ...
    receiptsLink: '',
    impactNotes: 'Serves 200+ students monthly',
    createdAt: '2026-01-15T10:00:00Z',
    updatedAt: '2026-01-25T14:30:00Z',
  },
  {
    id: 2,
    orgName: 'Student Wellness Coalition',
    category: 'wellness',
    description: 'Mental Health Awareness Week programming',
    requested: 3500,
    approved: 3500,
    spent: 1200,
    status: 'approved',
    semester: 'Spring 2026',
    receiptsLink: '',
    impactNotes: 'Expected to reach 1000+ students',
    createdAt: '2026-01-10T09:00:00Z',
    updatedAt: '2026-01-20T11:00:00Z',
  },
  {
    id: 3,
    orgName: 'Environmental Affairs Committee',
    category: 'events',
    description: 'Sustain Carolina Week events and materials',
    requested: 4000,
    approved: 3800,
    spent: 500,
    status: 'approved',
    semester: 'Spring 2026',
    receiptsLink: '',
    impactNotes: 'Campus-wide sustainability celebration',
    createdAt: '2026-01-08T15:00:00Z',
    updatedAt: '2026-01-18T10:00:00Z',
  },
  {
    id: 4,
    orgName: 'Tech Loaner Program',
    category: 'technology',
    description: 'Laptop and hotspot device maintenance',
    requested: 2500,
    approved: 2500,
    spent: 2500,
    status: 'spent',
    semester: 'Spring 2026',
    receiptsLink: '',
    impactNotes: 'Supports 50+ devices for student loans',
    createdAt: '2026-01-05T08:00:00Z',
    updatedAt: '2026-01-28T16:00:00Z',
  },
  {
    id: 5,
    orgName: 'Campus Safety Task Force',
    category: 'emergency',
    description: 'SafeWalk program expansion',
    requested: 2000,
    approved: 2000,
    spent: 800,
    status: 'approved',
    semester: 'Spring 2026',
    receiptsLink: '',
    impactNotes: 'Late-night safety for off-campus students',
    createdAt: '2026-01-12T14:00:00Z',
    updatedAt: '2026-01-22T09:00:00Z',
  },
  {
    id: 6,
    orgName: 'Student Government Marketing',
    category: 'marketing',
    description: 'Spring outreach campaign materials',
    requested: 1500,
    approved: 1200,
    spent: 0,
    status: 'approved',
    semester: 'Spring 2026',
    receiptsLink: '',
    impactNotes: 'Flyers, banners, social media promotion',
    createdAt: '2026-01-20T11:00:00Z',
    updatedAt: '2026-01-20T11:00:00Z',
  },
]

// Budget Enhancement - Sample Funding Requests (for demo mode)
export const sampleFundingRequests = [
  {
    id: 101,
    orgName: 'Carolina Esports',
    category: 'events',
    amount: 2500,
    description: 'Spring Gaming Tournament',
    justification: 'Annual tournament bringing together 200+ students across gaming communities. Promotes community building and healthy competition.',
    studentsImpacted: 200,
    status: 'pending',
    submittedAt: '2026-01-28T10:00:00Z',
    aiScore: {
      score: 72,
      recommendation: { action: 'APPROVE', confidence: 'medium', color: '#3fb950' },
    },
  },
  {
    id: 102,
    orgName: 'Pre-Med Society',
    category: 'travel',
    amount: 3000,
    description: 'Conference travel for 10 members',
    justification: 'Attending national pre-med conference for networking and career development opportunities.',
    studentsImpacted: 10,
    status: 'pending',
    submittedAt: '2026-01-27T14:00:00Z',
    aiScore: {
      score: 58,
      recommendation: { action: 'REVIEW', confidence: 'low', color: '#d29922' },
    },
  },
  {
    id: 103,
    orgName: 'Peer Counseling Network',
    category: 'wellness',
    amount: 1800,
    description: 'Crisis intervention training materials',
    justification: 'Training 30 peer counselors in mental health first aid and crisis intervention. Critical for student wellness support.',
    studentsImpacted: 500,
    status: 'pending',
    submittedAt: '2026-01-29T09:00:00Z',
    aiScore: {
      score: 88,
      recommendation: { action: 'APPROVE', confidence: 'high', color: '#3fb950' },
    },
  },
]
