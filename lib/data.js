...
export const initialPolicies = [
  ...
  // DEI
  { id: 'cultural-centers', department: 'dei', title: 'Cultural Center Support', description: 'Advocate for increased funding for cultural centers', status: 'planned', priority: 'high', progress: 0, digitalFeatures: ['center-directory', 'event-calendar', 'advocacy-portal'], metrics: { centers: 0, events: 0, funding: 0 } },
  { id: 'inclusive-excellence', department: 'dei', title: 'Inclusive Excellence Awards', description: 'Recognize students and orgs advancing DEI on campus', status: 'planned', priority: 'low', progress: 0, digitalFeatures: ['nomination-portal', 'voting-system', 'past-recipients'], metrics: { nominations: 0, categories: 0, recipients: 0 } },
  { id: 'first-gen', department: 'dei', title: 'First-Gen Support Network', description: 'Mentorship and resources for first-generation students', status: 'planned', priority: 'high', progress: 0, digitalFeatures: ['mentor-matching', 'resource-hub', 'community-forum'], metrics: { mentors: 0, mentees: 0, matches: 0 } },
  { id: 'accessibility-audit', department: 'dei', title: 'Accessibility Audit', description: 'Review campus accessibility and advocate for improvements', status: 'planned', priority: 'medium', progress: 0, digitalFeatures: ['issue-reporter', 'progress-tracker', 'resource-guide'], metrics: { issues: 0, resolved: 0, buildings: 0 } },
  { id: 'bias-training', department: 'dei', title: 'Bias Response Training', description: 'Training for student leaders on responding to bias incidents', status: 'planned', priority: 'medium', progress: 0, digitalFeatures: ['training-registration', 'resource-library', 'certification-tracker'], metrics: { trained: 0, sessions: 0, completion: 0 } },
  ...
  // STATE & EXTERNAL
  { id: 'tuition-advocacy', department: 'external', title: 'Tuition Advocacy', description: 'Lobby General Assembly against tuition increases', status: 'planned', priority: 'high', progress: 0, digitalFeatures: ['action-alerts', 'contact-reps', 'petition-system', 'impact-tracker'], metrics: { signatures: 0, contacts: 0, meetings: 0 } },
  { id: 'unc-coalition', department: 'external', title: 'UNC System Coalition', description: 'Coordinate with other UNC system student governments', status: 'planned', priority: 'medium', progress: 0, digitalFeatures: ['partner-directory', 'initiative-tracker', 'communication-hub'], metrics: { partners: 0, initiatives: 0, meetings: 0 } },
  { id: 'lobby-day', department: 'external', title: 'Legislative Lobby Day', description: 'Annual trip to Raleigh to advocate for higher ed funding', status: 'planned', priority: 'high', progress: 0, digitalFeatures: ['registration-system', 'training-modules', 'schedule-planner'], metrics: { participants: 0, meetings: 0, legislators: 0 } },
  { id: 'bot-liaison', department: 'external', title: 'Board of Trustees Liaison', description: 'Strengthen student voice in BOT meetings', status: 'planned', priority: 'medium', progress: 0, digitalFeatures: ['meeting-tracker', 'agenda-viewer', 'feedback-portal'], metrics: { meetings: 0, items: 0, feedback: 0 } },
  { id: 'federal-advocacy', department: 'external', title: 'Federal Advocacy', description: 'Engage with federal representatives on student issues', status: 'planned', priority: 'low', progress: 0, digitalFeatures: ['action-alerts', 'rep-directory', 'issue-tracker'], metrics: { actions: 0, contacts: 0, issues: 0 } },
]
...
export const initialOperationalData = {
  ...
  trainings: {
    ...
    biasResponse: { sessions: [], totalTrained: 0 },
  },
  ...
  programs: {
    ...
    firstGenNetwork: { mentors: [], mentees: [], matches: [] },
  },
  ...
  events: {
    townHalls: [],
    democracyWeek: [],
    lobbyDay: { registrations: [] },
  },

  // Petitions & Advocacy
  advocacy: {
    capsExpansion: { signatures: 0, signers: [] },
    tuitionFreeze: { signatures: 0, signers: [] },
...
export const culturalCenters = [
  { id: 1, name: 'Stone Center for Black Culture and History', location: 'South Building', phone: '919-962-9001', events: 0 },
  { id: 2, name: 'American Indian Center', location: 'Abernethy Hall', phone: '919-962-5236', events: 0 },
  { id: 3, name: 'Asian American Center', location: 'SASB North', phone: '919-962-0411', events: 0 },
  { id: 4, name: 'Carolina Latinx Center', location: 'SASB North', phone: '919-962-3250', events: 0 },
  { id: 5, name: 'LGBTQ Center', location: 'SASB North', phone: '919-843-5376', events: 0 },
]
