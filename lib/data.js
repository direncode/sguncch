...
export const departmentContacts = {
  ...
  civic: {
    lead: { name: 'Sarah Williams', title: 'Civic Engagement Chair', email: 'civic@unc.edu' },
    office: 'Student Union, Room 3110',
    hours: 'Tuesday-Friday 12pm-4pm',
    phone: '919-962-3198',
    socialMedia: '@UNCCivic',
  },
  communications: {
...
export const departmentFAQs = {
  ...
  civic: [
    { q: 'Am I registered to vote?', a: 'Check your registration status at ncsbe.gov/voter-search. You can register in NC if you\'ve lived here for 30+ days.' },
    { q: 'Where do I vote?', a: 'Your polling location depends on your registered address. Use the Polling Location finder on this page after entering your address.' },
    { q: 'Can I vote if I\'m from another state?', a: 'Yes! Request an absentee ballot from your home state, or register to vote in NC if you prefer.' },
    { q: 'How do I become a Civic Fellow?', a: 'Applications open in March for summer and fall placements. Fellows work 10-15 hours/week with local government offices.' },
    { q: 'Is there transportation to polls?', a: 'Yes, we run free shuttles on election days. Routes and schedules are posted one week before each election.' },
  ],
  communications: [
...
export const departmentAnnouncements = {
  ...
  civic: [
    { id: 1, date: '2026-01-26', title: 'Voter Registration Drive', content: 'Register to vote on the Pit Feb 3-7. Bring your ID and proof of address.', type: 'event' },
    { id: 2, date: '2026-01-20', title: 'Civic Fellows Applications Open', content: 'Summer 2026 Civic Fellows applications now open. Deadline March 1.', type: 'deadline' },
    { id: 3, date: '2026-01-14', title: 'Meet Your Representatives', content: 'Town Council members visiting campus Jan 30. Open Q&A in Union 3201.', type: 'event' },
  ],
  communications: [
...
export const serviceGuides = {
  ...
  'voter-registration': {
    title: 'How to Register to Vote in NC',
    steps: [
      { step: 1, title: 'Check Eligibility', description: 'Must be 18+ by Election Day, US citizen, NC resident for 30+ days' },
      { step: 2, title: 'Gather Documents', description: 'You\'ll need your driver\'s license or last 4 of SSN, plus proof of address' },
      { step: 3, title: 'Register Online', description: 'Visit ncsbe.gov or use our registration portal. Deadline is 25 days before election.' },
      { step: 4, title: 'Verify Registration', description: 'Check your status at ncsbe.gov/voter-search before Election Day' },
    ],
  },
  'research-position': {
