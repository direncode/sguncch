...
import { setAdminToken, clearAdminToken, setAdminRole as setSessionRole, clearAdminRole as clearSessionRole, getAdminRole as getSessionRole } from './adminSession'
...
export function AppProvider({ children }) {
  ...
  const logoutAdmin = () => {
    ...
    // Clear secure session, admin token, and role
    if (typeof window !== 'undefined') {
      clearSession()
      clearAdminToken()
      clearSessionRole()
