...
export default function CivicPage() {
  ...
  const contact = departmentContacts.civic
  const faqs = departmentFAQs.civic
  const announcements = departmentAnnouncements.civic
  const voterGuide = serviceGuides['voter-registration']
        ...
        <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          {activeTab === 'faq' && (
            <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-6">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-12 h-12 bg-[#a371f7]/20 border border-[#a371f7]/40 rounded-full flex items-center justify-center">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-[#8b949e]">📧</span>
                        <a href={`mailto:${contact.lead.email}`} className="text-[#a371f7] hover:underline">{contact.lead.email}</a>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-[#8b949e]">📱</span>
                  ...
                  <div className="mt-6 bg-[#161b22] border border-[#30363d] rounded-lg p-6">
                    ...
                    {feedbackSubmitted ? (
                      <div className="text-center py-4">
                        <div className="w-12 h-12 bg-[#a371f7]/20 rounded-full flex items-center justify-center mx-auto mb-3">
                          <span className="text-2xl">✓</span>
                        </div>
                        <p className="text-[#a371f7] font-medium">Thanks for your feedback!</p>
                        <button onClick={() => setFeedbackSubmitted(false)} className="text-[#8b5cf6] text-sm mt-2 hover:underline">Send another</button>
                      </div>
                    ) : (
                      <form onSubmit={handleFeedbackSubmit} className="space-y-4">
                        <Select label="Topic" name="topic" value={feedbackForm.topic} onChange={e => setFeedbackForm({...feedbackForm, topic: e.target.value})} required
                          options={[
                            { value: 'voting', label: 'Voter Registration' },
                            { value: 'fellows', label: 'Civic Fellows' },
                            { value: 'transit', label: 'Election Transit' },
                        ...
                        <button type="submit" className="w-full bg-[#a371f7] text-white px-4 py-2.5 rounded font-semibold hover:bg-[#8b5cf6] transition-colors">
                          Submit Feedback
                        </button>
                      </form>
                    )}
              ...
              {/* How-To Guide */}
              <div>
                <h3 className="text-lg font-bold text-[#f0f6fc] tracking-tight mb-4">{voterGuide.title}</h3>
                <div className="grid md:grid-cols-4 gap-4">
                  {voterGuide.steps.map((step) => (
                    <div key={step.step} className="bg-[#161b22] border border-[#30363d] rounded-lg p-5 relative">
                      <div className="absolute -top-3 left-4 bg-[#a371f7] text-white text-xs font-bold px-2 py-1 rounded">
                        Step {step.step}
                      </div>
                  ...
                  {announcements.map(ann => (
                    <div key={ann.id} className="bg-[#161b22] border border-[#30363d] rounded-lg p-4 flex items-start gap-4">
                      <div className={`px-2 py-1 rounded text-xs font-mono ${
                        ann.type === 'event' ? 'bg-[#a371f7]/10 text-[#a371f7] border border-[#a371f7]' :
