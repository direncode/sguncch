...
import type { UserRole, JWTPayload } from '@project-bold/shared';
 ...
 */
export const requireCabinet = requireRoles('cabinet_member', 'admin');

/**
 * Require senator, cabinet, or admin
 */
export const requireSenator = requireRoles('senator', 'cabinet_member', 'admin');

/**
 * Require org leader or higher
 */
export const requireOrgLeader = requireRoles('org_leader', 'senator', 'cabinet_member', 'admin');
